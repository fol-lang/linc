...
pub use ir::{
    ...
    LinkArtifact, LinkArtifactKind, LinkLibrary, LinkLibraryKind, ParameterBinding, RecordBinding,
    RecordKind, TypeAliasBinding, UnsupportedItem, VariableBinding, SCHEMA_VERSION,
};
